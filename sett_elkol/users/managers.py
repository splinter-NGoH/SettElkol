...
class CustomUserManger(BaseUserManager):
    ...
    def create_user(
        self, username, email, password, first_name,country,user_type, **extra_fields
    ):
        if not username:
    ...
    def create_superuser(
        self, username, email, password, first_name,country,user_type,gender, **extra_fields
    ):
        ...
        user = self.create_user(
            username, email, password, first_name,country,user_type, **extra_fields
        )
        user.save(using=self._db)
        return user