# Generated by Django 4.0.10 on 2023-04-17 07:34
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('chef', 'chef'), ('customer', 'customer'), ('guest', 'guest')], default='customer', max_length=20, verbose_name='User Type')),
                ('country', django_countries.fields.CountryField(default='EG', max_length=2, verbose_name='country')),
                ('city', models.CharField(default='Egypt', max_length=180, verbose_name='city')),
