...
class CartItem(TimeStampedUUIDModel):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name="cart_items_user")
    meal = models.ForeignKey(Meal , related_name="meal_cart_items", on_delete=models.CASCADE)
